...
class KittiStereoDataset(Custom3DDataset):
    r"""KITTI Dataset.
    ...
    def get_data_info(self, index):
        ...
        img_filename = [os.path.join(self.data_root,info['image']['image_left_path']),os.path.join(self.data_root,info['image']['image_right_path'])]
        ...
        lidar2img = [P2 @ rect @ Trv2c, P3 @ rect @ Trv2c]
